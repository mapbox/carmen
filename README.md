...
geocoder_vttolerance| Optional + advanced. Allows a custom tolerance level around vector tile features for calculating pyramids. Defaults to 50 merc metres.
