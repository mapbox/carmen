...
function MemSource(docs, info, callback) {
    ...
    this._info.geocoder_version =
        this._info.geocoder_version !== undefined
            ? this._info.geocoder_version
            : 8;
    this.open = true;
    this.docs = docs;
...
MemSource.prototype.geocoderDataIterator = function(type) {
    ...
    var shardKeys = Object.keys(shards).map(function(k) {
        return parseInt(k, 10);
    });
    shardKeys = shardKeys.sort(function(a, b) {
        return a - b;
    });
