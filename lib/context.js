        ...
        vt.query(lon, lat, {
            ...
            if (reverseMode === 'score' && full && source.geocoder_reverse_mode) {
                for (var j = 0; j < results.length; j++) {
                    results[j].score = results[j].attributes()['carmen:score'];
                }
...
function sortByDistScore(a, b) {
    ...
    var a_distscore = proximity.distscore(a.distance, a.score);
    var b_distscore = proximity.distscore(b.distance, b.score);
