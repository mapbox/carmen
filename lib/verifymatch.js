...
function verifyContext(context, strict, loose, indexes) {
    ...
    var stacky = 0;
    var squishy = 0;
    var squishyEligible = !indexes[context[0].properties["carmen:index"]].prevent_promotion;
    var usedmask = 0;
    var lastmask = -1;
    var lastgroup = -1;
    var relevance = 0;
    ...
    for (var c = 0; c < context.length; c++) {
        ...
        if (squishyEligible && (c > 0) && (feat.properties["carmen:text"] === context[0].properties["carmen:text"]))
            squishy += 1;
