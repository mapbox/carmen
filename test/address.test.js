...
test('address.reverse - null ITP', t => {
    ...
    t.deepEqual(
                    ...
                    geometries: [
                        {
                            ...
                            coordinates: [
                                [
                                    [151.16566753014922, -33.929532190798234],
                                    [151.16543367505074, -33.92981573230553],
                                    [151.16538212634623, -33.92999384067741],
                                    [151.16541649214923, -33.93020039306708],
                                    [151.16594002582133, -33.93236526842762],
                                    [151.1659766547382, -33.93249176960996],
                                    [151.16603415459394, -33.93255269039818],
                                    [151.16609844379127, -33.932585932545074],
                                    [151.16631478071213, -33.93257793495862],
                                    [151.16614806465805, -33.932624251405414],
                                    [151.16598704829812, -33.932640942010686],
                                    [151.16596475243568, -33.932633153061964],
                                    [151.16588294506073, -33.93260463994003],
                                    [151.16582066752017, -33.932524594514966],
                                    [151.16524072363973, -33.93022807244016],
                                    [151.1651679687202, -33.92990169172244],
                                    [151.16538212634623, -33.92999384067741]
                                ]
                            ]
                        }
        ...
        {
            geometry: {
                coordinates: [151.16590392952008, -33.9322160058351],
                type: 'Point'
            },
            id: 75018674165319,
            properties: {
...
test('address.reverse', t => {
    t.deepEqual(
        ...
        {
            geometry: {
                coordinates: [-77.03195250715466, 38.913897567510446],
                type: 'Point'
            },
            id: 75018674165319,
            properties: {
    ...
    t.deepEqual(
        ...
        {
            geometry: {
                coordinates: [-77.03195235613184, 38.913917250817995],
                type: 'Point'
            },
            id: 75018674165319,
            properties: {
...
test('address.matchSide', t => {
    t.deepEqual(
        address.matchSide(
            ...
            'right',
            {
                lineDist: 0.05149142157672657,
                pt: {
                    type: 'Feature',
                    geometry: {
                        type: 'Point',
                        coordinates: [-77.03195179501776, 38.913990382686116]
                    },
                    properties: {
                        dist: 0.003796989313476002,
                        travelled: 0.04432977933096455,
                        index: 1
                    }
                },
                startLine: {
                    ...
                    geometry: {
                        type: 'Point',
                        coordinates: [-77.031954, 38.913703]
                    },
                    properties: {}
                },
                endLine: {
                    ...
                    geometry: {
                        type: 'Point',
                        coordinates: [-77.031951, 38.914094]
                    },
                    properties: {}
                },
                i: 6
        ...
        address.matchSide(
            ...
            'left',
            {
                ...
                pt: {
                    ...
                    properties: {
                        dist: 0.008056283111657007,
                        travelled: 0.03791474058649927,
                        index: 1
                    }
                },
                startLine: {
...
test('address.getReversePoint', t => {
    ...
    t.deepEqual(
        address.getReversePoint(
            [-77.19932645559311, 38.94770308373527],
            [
                [-77.19998091459274, 38.9475549770314],
                [-77.19883829355238, 38.94759461125006]
            ],
            'miles'
        ),
        {
            endLine: {
                geometry: {
                    coordinates: [-77.19883829355238, 38.94759461125006],
                    type: 'Point'
                },
                properties: {},
                type: 'Feature'
            },
            lineDist: 0.061479507908799705,
            pt: {
                geometry: {
                    coordinates: [-77.19932038464033, 38.94757788890475],
                    type: 'Point'
                },
                properties: {
                    dist: 0.008658996759104212,
                    index: 0,
                    travelled: 0.035540270815552055
                },
                type: 'Feature'
            },
            startLine: {
                geometry: {
                    coordinates: [-77.19998091459274, 38.9475549770314],
                    type: 'Point'
                },
                properties: {},
                type: 'Feature'
    ...
    t.deepEqual(
        address.getReversePoint(
            [-77.1995061635971, 38.94741938611567],
            [
                [-77.19998091459274, 38.9475549770314],
                [-77.19883829355238, 38.94759461125006]
            ],
        ...
        ),
        {
            ...
            pt: {
                geometry: {
                    coordinates: [-77.1995173939109, 38.947571055223044],
                    type: 'Point'
                },
                properties: {
                    dist: 0.010499982934844238,
                    index: 0,
                    travelled: 0.024940051989783316
                },
                type: 'Feature'
            },
            startLine: {
    ...
    t.deepEqual(
        address.getReversePoint(
            [-77.20057904720306, 38.94761547135627],
            [
                [-77.19998091459274, 38.9475549770314],
                [-77.19883829355238, 38.94759461125006]
            ],
    ...
    t.deepEqual(
        address.getReversePoint(
            [-77.19858080148697, 38.94759461125006],
            [
                [-77.19998091459274, 38.9475549770314],
                [-77.19883829355238, 38.94759461125006]
            ],
        ...
        ),
        {
            ...
            pt: {
                ...
                properties: {
                    dist: 0.013840773622621594,
                    index: 0,
                    travelled: 0.061479507908799705
                },
                type: 'Feature'
            },
            startLine: {
...
test('address.standardize', t => {
    t.deepEqual(
        address.standardize({ properties: { 'carmen:rangetype': 'canvec' } }),
        [],
        'canvec rangetype'
    );
    t.deepEqual(
        address.standardize({ properties: { 'carmen:rangetype': 'tiger' } }),
        []
    ),
        'no geometry';
    t.deepEqual(
...
test('address.setPoint', t => {
    t.deepEqual(
        address.setPoint(2, 0, 8, [[0, 0], [1, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0.25, 0]
    ...
    t.deepEqual(
        address.setPoint(2, 8, 0, [[0, 0], [1, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0.75, 0]
    ...
    t.deepEqual(
        address.setPoint(2, 8, 0, [[0, 0], [0, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0, 0]
    ...
    t.deepEqual(
        address.setPoint(0, 0, 0, [[0, 0], [1, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0, 0]
    ...
    t.deepEqual(
        address.setPoint(3, 0, 12, [[0, 0], [1, 0], [2, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0.5, 0]
    ...
    t.deepEqual(
        address.setPoint(9, 0, 12, [[0, 0], [1, 0], [2, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [1.5, 0]
    ...
    t.deepEqual(
        address.setPoint(9, 0, 12, [[0, 0], [0, 0], [0, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0, 0]
    ...
    t.deepEqual(
        address.setPoint(0, 0, 0, [[0, 0], [1, 0], [2, 0]], false),
        {
            type: 'Point',
            interpolated: true,
            coordinates: [0, 0]
...
test('address interpolation - noop', t => {
    t.deepEqual(
        false,
        address.forward({ properties: { 'carmen:rangetype': '' } }, 100)
    );
    t.deepEqual(
        false,
        address.forward({ properties: { 'carmen:rangetype': 'tiger' } }, 100)
    );
    t.deepEqual(
        false,
        address.forward(
            {
                properties: { 'carmen:rangetype': 'tiger' },
                geometry: { type: 'Point', coordinates: [-78, 40] }
            },
            100
        )
    );
                    ...
                    features: [
                        {
                            ...
                            coordinates: [
                                [
                                    [-17.2265625, 8.407168163601076],
                                    [-17.2265625, 53.9560855309879],
                                    [34.80468749999999, 53.9560855309879],
                                    [34.80468749999999, 8.407168163601076],
                                    [-17.2265625, 8.407168163601076]
                                ]
                            ]
                        }
        ...
        address.forward(
            {
                ...
                geometry: {
                    ...
                    geometries: [
                        {
                            type: 'MultiLineString',
                            coordinates: [[[0, 0], [0, 10]], [[0, 40], [0, 50]]]
                        }
                    ]
                }
            },
