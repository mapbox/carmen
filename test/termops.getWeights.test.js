...
test('termops.getWeights', t => {
    ...
    t.deepEqual(
        res,
        [0.047820577394264194, 0.47608971130286787, 0.47608971130286787],
        'weights terms'
    );
    ...
    t.deepEqual(
        res,
        [0.2, 0.038256461915411356, 0.3808717690422943, 0.3808717690422943],
    ...
    t.deepEqual(
        res,
        [0.038256461915411356, 0.3808717690422943, 0.3808717690422943, 0.2],
        'weights numTokens @ 0.2 and adjusts others'
    );
    t.equal(res.reduce(sum, 0), 1, 'weights sum to 1');
